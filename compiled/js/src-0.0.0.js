...
},{"../../lib/codemirror":4,"../fold/xml-fold":2}],2:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
...
CodeMirror.defineMode("elaborate", function() {
  var tags;
  tags = ['i', 'b', 'u'];
  return {
    startState: function() {
      var state, tag, _i, _len;
      state = {};
    ...
    token: function(stream, state) {
      var matched, regexpEndAnno, regexpEndTag, regexpStartAnno, regexpStartTag, tokenName;
...
html = "van <b>d<u>een</b></u> Heer <1>Maurg</1><u>neau</u>lt Presid<i>ent </i> v<i>an\'t </i>E<i>dele</i><i> </i>hof.";

module.exports = document.addEventListener('DOMContentLoaded', function() {
  var codeMirror;
  return codeMirror = CodeMirror(document.getElementById('app'), {
    value: html,
    lineNumbers: true,
    lineWrapping: true,
    mode: 'elaborate',
...
},{"codemirror":4,"codemirror/addon/edit/matchtags":1,"codemirror/addon/selection/active-line":3}]},{},[5])